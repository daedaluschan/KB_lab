...
2. Add or update the matching destination table row. Keep the columns and owner values unchanged: `已買`, `物品`, `擁有人`, `相片`; owners are `Dad`, `Mom`, and `Jinny`.
...
5. Place items with no decided purchase location in the `## TBD` table. Do not change the page title or navigation for this holding section.
